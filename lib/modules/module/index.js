...
module.exports = function (config, specs, runtime) {
    ...
    this.initialise = async(function *(resolve, reject) {
        ...
        if (config.page) {
            ...
            if (typeof config.widget === 'string') {
                config.widget = {'name': config.page};
            }
            type = config.widget;
            type.type = 'widget';
        ...
        if (config.code) this.code = require('./code.js')(this, type, config.code);
        if (config.custom) this.custom = require('./custom.js')(this, type, config.custom);
        if (config.polymer) this.polymer = require('./polymer.js')(this, type, config.polymer);

var Beyond = function (beyond) {
    ...
    // if socket.io is located on any other URL, change or overwrite the following property
    this.socketIO_URL = 'libraries/vendor/static/bower_components/socket.io-client/socket.io.js';

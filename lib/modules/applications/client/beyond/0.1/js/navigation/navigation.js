function Navigation(beyond, pages, events) {
    ...
    function defaultRoute() {
        ...
        if (typeof defaultRoute === 'object' &&
            ...
            if (auth.session.valid && typeof defaultRoute.loggedIn === 'string')
                pathname = defaultRoute.loggedIn;

            if (!auth.session.valid && typeof defaultRoute.loggedOut === 'string')
                pathname = defaultRoute.loggedOut;
    ...
    var onpopstate = Delegate(this, 'onPopState');

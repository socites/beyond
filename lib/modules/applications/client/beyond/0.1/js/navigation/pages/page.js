...
function Page(pathname, module, specs, parameter) {
    ...
    /*
     When onrendered is called, the page is ready on screen.
     It is required by phantom, but can have other purposes.
     */
    function onrendered() {
        // TODO: Add phantom code
    }

    var showing;
    var show = Delegate(this, function (done) {

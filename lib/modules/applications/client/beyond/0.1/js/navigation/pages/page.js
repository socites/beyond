/* The Page object is a wrapper to the page object created
 ...
 Then the render method is called (if exists). After calling the render method, then the "prepare" method
 is called. The prepared method is asynchronous, and it is also optional.
 After the "prepare" method is executed (only if exists), then the show method is executed.
...
function Page(pathname, module, specs, parameter) {
    ...
    var show = Delegate(this, function () {
        ...
        if (!showTime || !rendered || showing || showed) return;

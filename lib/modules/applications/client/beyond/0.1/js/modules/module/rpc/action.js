        ...
        var execute = Delegate(this, function () {
            ...
            if (typeof this.ackTimeout === 'number') {
                ...
                timers.ack = setTimeout(Delegate(this, function () {
                    ...
                    if (typeof this.onError === 'function') this.onError('timedout', 'ack');
            ...
            channel.emit('rpc', request.serialized, Delegate(this, function (acknowledgeID) {
                ...
                timers.response = setTimeout(function () {
                    ...
                    if (typeof this.onError === 'function') this.onError('timedout', 'response');
        ...
        this.execute = function (callback) {
            ...
            if (typeof this.holdersTimeout === 'number') {
                ...
                timers.holders = setTimeout(Delegate(this, function () {
                    ...
                    if (typeof this.onError === 'function') this.onError('timedout', 'holders');

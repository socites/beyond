function Action(module, events) {
    ...
    return function (actionPath, params) {
        ...
        var execute = Delegate(this, function (error) {
            ...
            if (error) {
                ...
                executing = false;
                console.error('Holder error', error);
                return;
            ...
            if (typeof this.ackTimeout === 'number') {
                ...
                timers.ack = setTimeout(Delegate(this, function () {
                    ...
                    if (typeof this.onError === 'function') this.onError('timedout', 'Acknowledge timeout.');
            ...
            channel.emit('rpc', request.serialized, Delegate(this, function (acknowledgeID) {
                ...
                timers.response = setTimeout(function () {
                    ...
                    if (typeof this.onError === 'function') this.onError('timedout', 'Response not received in time.');
        ...
        this.execute = function (callback) {
            ...
            if (typeof this.holdersTimeout === 'number') {
                ...
                timers.holders = setTimeout(Delegate(this, function () {
                    ...
                    if (typeof this.onError === 'function') this.onError('timedout', 'At least one RPC holder did not release the implementation of the action.');

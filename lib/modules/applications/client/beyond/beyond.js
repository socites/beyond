var Beyond = function (beyond) {
    ...
    // errorHandler is connected to the ui/toast module
    this.errorHandler = new ErrorHandler();
    // Shortcuts to registerError and removeError
    this.registerError = Delegate(this.errorHandler, this.errorHandler.registerError);
    this.removeError = Delegate(this.errorHandler, this.errorHandler.removeError);
    ...
    this.start = function () {
        ...
        if (!$('body > .container').length) {
            console.error('body > .container does not exist');
        }

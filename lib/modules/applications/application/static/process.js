...
module.exports = async(function *(resolve, reject, resource, application, runtime, language) {
    ...
    if (resource.contentType === 'text/html' && ['index.html', 'index.htm'].indexOf(filename) !== -1) {
        ...
        scripts += '<!-- beyond.js -->\n';
        scripts += '<script defer src="' + hosts.beyond + 'main.js"></script>\n\n';
        scripts += '<script defer src="' + hosts.vendor + 'main.js"></script>\n\n';
        scripts += '<script defer src="' + hosts.ui + 'toast.js"></script>\n\n';

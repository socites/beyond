 ...
 * @param order
 */
module.exports = async(function *(resolve, reject, application, module, language, overwritesConfig) {
    "use strict";
    ...
    for (let key of keys) {
        ...
        let overwrites = require('./overwrites')(overwritesConfig, module.ID, extender.ID);

        ...
        for (let i in dirs) {
            ...
            if (specs.platforms) {
                ...
                if (specs.platforms.indexOf(phonegapConfName) === -1) {
                    console.log('Platform "' + phonegapConfName + '" nof found');
                    continue;
                }
            ...
            for (let language of languages) {
                ...
                if (specs.local) {
                    ...
                    let cmd = 'phonegap build android';
                    console.log('calling phonegap build, platform "' + phonegapConfName + '"');

                    childProcess.exec(cmd, {'cwd': cwd, 'killSignal': 1},
                        (error, stdout, stderr) => {
                            "use strict";

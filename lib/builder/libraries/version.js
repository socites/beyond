...
module.exports = require('async')(function *(resolve, reject, version) {
    "use strict";
    ...
    for (let key of version.modules.keys) {
        ...
        // building code script
        if (module.polymer && specs.polymer) {
        ...
        if (server && server.actions && specs.ws) {

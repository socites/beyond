        ...
        for (let v of library.versions.keys) {
            ...
            for (let key of version.modules.keys) {
                ...
                if (library.service.code) {
                    ...
                    libraryJson.ws.service = library.service.config;
                    libraryJson.ws.service.path = './service';

                    let source = library.service.path;
                    let destination = require('path').join(library.build.ws, 'service');

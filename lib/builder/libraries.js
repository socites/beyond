module.exports = require('async')(function *(resolve, reject, modules, languages, opts) {
    "use strict";
    ...
    for (let name of libraries.keys) {
        ...
        for (let v of library.versions.keys) {
            ...
            for (let key of version.modules.keys) {
                ...
                if (opts.specs) libraryJson.versions[version.version] = {
                    'build': {'hosts': version.build.hosts}
                };

                if (version.start && opts.specs && opts.start)

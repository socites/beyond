...
module.exports = new (function () {
    ...
    this.build = async(function *(resolve, reject, config, modules, specs) {
        ...
        if (specs.libraries) yield require('./libraries')(modules, languages, specs.libraries, buildPath);
        if (specs.applications) yield require('./applications')(modules, languages);

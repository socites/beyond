...
module.exports = function (porthttp,modules, specs, runtime) {
    "use strict";
    ...
    for (let application of applications.keys) {
        ...
        yaol.info(yaolMessenger,'\t\tlistening application ' + application.name);
    ...
    yaol.info(yaolMessenger, 'go to browser on http://localhost:'+porthttp+'/'+modules.applications.keys[0]+'/en/');

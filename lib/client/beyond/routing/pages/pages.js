 ...
 */
function Pages(events, Dependencies) {
    'use strict';
    ...
    let routes = {};
    Object.defineProperty(this, 'routes', {'get': () => routes});

    // Registered pathnames who have a known associated moduleID
    let pathnames = {};
    Object.defineProperty(this, 'pathnames', {'get': () => pathnames});
    ...
    let create = function (pathname, moduleID, state, vdir) {
    ...
    this.get = function (pathname, state, callback) {
        ...
        events.trigger(event, pathname, function (response) {
            ...
            let moduleID = response.moduleID;

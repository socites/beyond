function Behavior(module, specs) {
    ...
    // Check sna function
    if (typeof specs.creator !== 'function') {
    ...
    function onDependenciesReady() {
        ...
        var creator = specs.creator(dependencies);
        var sna = new SNA();
        this._setSNA(specs.Controller, specs.State, specs.Actions, creator);
    ...
    this._onPropertyChanged = function () {
    ...
    this._setSNA = function (value) {
        ...
        this._sna.properties.bind('change', Delegate(this, this._onPropertyChanged));
    ...
    function onMethodExecuted(name) {
        ...
        return this._sna[name].actions.apply(this._sna, args);

function Navigation(pages, events) {
    'use strict';
    ...
    let _showPage = Delegate(this, function (pathname, search, state, callback) {
    ...
    let defaultUrl = Delegate(this, function (callback) {
    ...
    let navigateWebWarning = Delegate(this, function () {
     ...
     */
    let updateNavigation = Delegate(this, function (callback) {
    ...
    let onpopstate = Delegate(this, function () {

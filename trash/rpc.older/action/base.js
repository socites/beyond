function ActionBase(module, events) {
    ...
    let TIMEOUT_REASON = Object.freeze({
        'PRE_EXECUTION': 1,
        'ACKNOWLEDGE': 2,
        'WAITING_RESPONSE': 3
    });
    ...
    return function (path, params) {
        ...
        let execute = Delegate(this, function (holderError) {
        ...
        let onSocketError = Delegate(this, function () {
        ...
        let onSocketDisconnect = Delegate(this, function () {
        ...
        let onConnectionFailed = Delegate(this, function () {
        ...
        let onResponse = Delegate(this, function (response) {
        ...
        this.execute = function () {
            ...
            //      holder.push('reason');
            //      holder.done('reason');
            // When there are no reasons to hold the execution, then the callback is called
